...
/**
 * Scales the dimensions so that it fits entirely inside the parent.One of width or height will fit
 * exactly. Aspect ratio is preserved.
 */
public class CenterCropStrategy extends PreviewScalingStrategy {
    ...
    protected float getScore(Size size, Size desired) {
        ...
        float cropRatio =
                scaled.width * 1.0f / desired.width + scaled.height * 1.0f / desired.height;
