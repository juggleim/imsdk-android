...
import com.juggle.chat.qrcode.barcodescanner.Size;
...
public abstract class PreviewScalingStrategy {
     ...
     *
     * <p>The default implementation lets subclasses calculate a score for each size, the picks the
     * one with the best score.
     *
     * <p>The sizes list may be reordered by this call.
     *
     ...
     *
     * <p>In most cases, {@link #getBestPreviewSize(List, Size)} should be used instead.
     *
     * <p>The sizes list may be reordered by this call.
     *
     * @param sizes supported preview sizes, containing at least one size. Sizes are in natural
