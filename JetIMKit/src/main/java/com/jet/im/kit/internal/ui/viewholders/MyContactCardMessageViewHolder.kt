...
class MyContactCardMessageViewHolder internal constructor(
    val binding: SbViewMyContactCardMessageBinding,
    ...
    override fun bind(
        ...
        binding.myContactCardMessageView.messageUIConfig = messageUIConfig
        binding.myContactCardMessageView.drawMessage(channel, message, reactionItemList, params)
    }
    ...
    override fun setEmojiReaction(
        ...
        binding.myContactCardMessageView.binding.rvEmojiReactionList.apply {
    ...
    override fun getClickableViewMap(): Map<String, View> {
        return mapOf(
            ClickableViewIdentifier.Chat.name to binding.myContactCardMessageView.binding.contentPanel,
        )
    }
}