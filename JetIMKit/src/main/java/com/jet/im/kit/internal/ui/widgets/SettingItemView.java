...
import com.jet.im.kit.widgets.SwitchButton;
...
public class SettingItemView extends LinearLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        view.setBackgroundResource(R.drawable.mine_setting_item_selector);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        float defHeight = getResources().getDimension(R.dimen.sb_size_48);
