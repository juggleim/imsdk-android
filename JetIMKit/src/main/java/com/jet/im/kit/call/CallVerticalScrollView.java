...
public class CallVerticalScrollView extends ScrollView implements ICallScrollView{
    ...
    public void addChild(String childId, UserInfo userInfo, String state) {
        ...
        ImageView imageView = child.findViewById(R.id.rc_user_portrait);
        ...
        if (userInfo != null) {
            ViewUtils.drawProfile(imageView, userInfo.getPortrait(), userInfo.getPortrait());
            name.setText(userInfo.getUserName() == null ? userInfo.getUserId() : userInfo.getUserName());
        } else {
    ...
    public void updateChildState(String childId, boolean visible) {
        ...
        for (int i = 0; i < containerCount; i++) {
            ...
            if (child != null) {
                ...
                ImageView imageView=child.findViewById(R.id.callkit_mutilAudio_Floatinglayer);
